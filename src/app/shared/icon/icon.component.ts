...
const P: Record<string, string> = {
  key: '<circle cx="8" cy="15" r="4"/><path d="M10.1 13.1 21 2"/><path d="M18 5h3v3"/>',
  users:
    '<path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M22 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/>',
  bank: '<path d="M10 18v-7"/><path d="M14 18v-7"/><path d="M3 22h18"/><path d="M5 10h14"/><path d="m12 2 9 4H3z"/>',
  ...
  sparkles:
    '<path d="M9.9 2.1 11 6l3.9 1.1L11 8.2 9.9 12 8.8 8.2 5 7.1 8.8 6z"/><path d="M19 9l.7 2.1L22 12l-2.3.9L19 15l-.7-2.1L16 12l2.3-.9z"/>',
  ...
  clock: '<path d="M3 12a9 9 0 1 0 3-6.7"/><path d="M3 3v5h5"/><path d="M12 7v5l3 3"/>',
};

@Component({
  selector: 'app-icon',
  standalone: true,
  template: `<span class="i" [innerHTML]="svg" aria-hidden="true"></span>`,
  styles: [
    `:host{display:inline-flex;line-height:0}.i,:host ::ng-deep svg{display:block;width:1.2em;height:1.2em}`,
  ],
})
export class IconComponent implements OnChanges {
  ...
  private render(): void {
    const body = P[this.icon] || P['sparkles'];
    this.svg = this.s.bypassSecurityTrustHtml(
